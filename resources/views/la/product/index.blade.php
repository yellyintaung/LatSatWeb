...
<div class="card-header">
    ...
    <a href="/admin/product/create" class="btn btn-sm btn-success float-right py-1" style="visibility:visibile;"><i class="fas fa-plus"></i> ADD</a>
    ...
    <tbody class="table_body">
       ...
       if (isset($_GET['page'])) {
        ...
        <tr>
            ...
            <td>
                <a href="/admin/product/{{ $item->id }}" class="btn btn-sm py-1" style="background-color:#007BFF;color:white;">View</a>
                
                <a href="/admin/product/{{ $item->id }}/edit" class="btn btn-sm py-1" style="background-color:#FFC107;color:black;">Edit</a>
